...
public class SumStandings {
	...
	public SumStandings(String name, int numberOfPlayedGames, Date date, int won, int lost, double percentige,
	...
	public SumStandings(String id, String name, int numberOfPlayedGames, Date date, int won, int lost,
			double percentige, int homeWin, int homeLost, int roadWin, int roadLost, int divisonWin, int divisonLost,
			int conferenceWin, int conferenceLost, int last10Win, int last10Lost, LinkedList<Boolean> last10Games) {
		super();
		this.id = id;
		this.name = name;
		this.numberOfPlayedGames = numberOfPlayedGames;
	...
	public SumStandings(String name) {
		super();
		this.name = name;
	}
